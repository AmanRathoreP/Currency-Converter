...
\tname=\"{app_name}\",
    ...
    files.extend(
        get_files_name_with_particular_extensions(
            [
                os.path.join('.'),
                os.path.join('.', "vendor", "format_currency", "src", "format_currency", "data"),
                os.path.join('.', "vendor", "countries_flag"),
                os.path.join('.', "vendor", "countries_flag", "png"),
                ],
            ["json", "png"],
